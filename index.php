...
?>
  ...
  <head>
    ...
    <link rel="icon" type="image/png" href="asset/img/logo/logo.ico">
    <!-- Bootstrap CSS -->
    ...
    <title>
      PEREKAPAN DATA INSTANSI FARMASI "MESTI WARAS"
      <?php
      if (@$_GET['page'] == '') {
        echo "Dashboard";
  ...
  <body class="bg-light">
    <!-- <div class="logo bg-info">
  		<span class="navbar-brand logo-atas text-white" href="#">PEREKAPAN DATA INSTANSI FARMASI "ORA WARAS"</span>
  	</div> -->
    <div id="container">
      <div id="main">
        <div class="col-md-12 bg-info p-1 title">
          ...
          <div class="row">
            <div class="col-md-6">
              <span class="text-white font-weight-light">PEREKAPAN DATA INSTANSI FARMASI "MESTI WARAS"</span>
            </div>
              ...
              <div id="menu-collapse" class="collapse show" aria-labelledby="" data-parent="#menu">
                <div class="accordion" id="daftar_menu">
                  <ul class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-action <?php if (@$_GET['page'] == 'dataobat' || @$_GET['page'] == 'datapegawai' || @$_GET['page'] == 'tambah_dataobat' || @$_GET['page'] == 'tambah_datapegawai' || @$_GET['page'] == 'edit_datapegawai' || @$_GET['page'] == 'edit_dataobat' || @$_GET['page'] == 'datasupplier' || @$_GET['page'] == 'tambah_datasupplier' || @$_GET['page'] == 'edit_datasupplier' || @$_GET['page'] == 'info_kadaluarsa') {
                                                                                echo "show";
                    ...
                    <div id="menu-collapse-master" class="collapse <?php if (@$_GET['page'] == 'dataobat' || @$_GET['page'] == 'datapegawai' || @$_GET['page'] == 'tambah_dataobat' || @$_GET['page'] == 'info_kadaluarsa' || @$_GET['page'] == 'tambah_datapegawai' || @$_GET['page'] == 'edit_datapegawai' || @$_GET['page'] == 'edit_dataobat' || @$_GET['page'] == 'datasupplier' || @$_GET['page'] == 'tambah_datasupplier' || @$_GET['page'] == 'edit_datasupplier') {
                                                                      echo "show";
                                                                    } ?>" aria-labelledby="" data-parent="#daftar_menu">
                      <ul class="list-group list-group-collapse">
                        <a href="?page=dataobat" class="list-group-item list-group-item-action list-group-item-collapse <?php if (@$_GET['page'] == 'dataobat' || @$_GET['page'] == 'tambah_dataobat' || @$_GET['page'] == 'edit_dataobat' || @$_GET['page'] == 'info_kadaluarsa') {
                                                                                                                          echo "active";
                                                                                                                        } ?>" style="border-radius: 0px;">
                          <i class="fas fa-angle-right"></i> Data Obat <i class="fas fa-capsules float-right mt-1"></i>
                        </a>
                        <a href="?page=datapegawai" class="list-group-item list-group-item-action list-group-item-collapse <?php if (@$_GET['page'] == 'datapegawai' || @$_GET['page'] == 'tambah_datapegawai' || @$_GET['page'] == 'edit_datapegawai') {
                                                                                                                              echo "active";
                                                                                                                            } ?>">
                          <i class="fas fa-angle-right"></i> Data Pegawai <i class="fas fa-users float-right mt-1"></i>
                        </a>
                        <a href="?page=datasupplier" class="list-group-item list-group-item-action list-group-item-collapse <?php if (@$_GET['page'] == 'datasupplier' || @$_GET['page'] == 'tambah_datasupplier' || @$_GET['page'] == 'edit_datasupplier') {
                                                                                                                              echo "active";
                                                                                                                            } ?>">
                    ...
                    <a href="?page=entry_datapenjualan" class="list-group-item list-group-item-action <?php if (@$_GET['page'] == 'datapenjualan' || @$_GET['page'] == 'entry_datapenjualan' || @$_GET['page'] == 'form_laporanpenjualan' || @$_GET['page'] == 'datapenjualan_perobat') {
                                                                                                        echo "active";
                                                                                                      } ?>">
                    ...
                    <?php if ($_SESSION['posisi_peg'] == 'Admin' || $_SESSION['posisi_peg'] == 'Manager' || $_SESSION['posisi_peg'] == 'Apoteker') { ?>
                      <a href="?page=entry_datapembelian" class="list-group-item list-group-item-action <?php if (@$_GET['page'] == 'datapembelian' || @$_GET['page'] == 'entry_datapembelian' || @$_GET['page'] == 'form_laporanpembelian') {
                                                                                                          echo "active";
                                                                                                        } ?>">
                    ...
                    <!-- <a href="?page=laporan" class="list-group-item list-group-item-action <?php if (@$_GET['page'] == 'laporan') {
                                                                                                  echo "active";
                                                                                                } ?>">
    ...
    <footer>
      <i class="fas fa-copyright"></i> By Muhammad Edi Ilfa 21120118120017
    </footer>
    <!-- Optional JavaScript -->

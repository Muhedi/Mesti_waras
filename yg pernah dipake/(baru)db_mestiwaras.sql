...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Nov 2021 pada 02.00
...
INSERT INTO `detail_pembelian` (`id_detailpembelian`, `no_faktur`, `kd_obat`, `exp_obatbeli`, `hrg_beli`, `jml_beli`, `sat_beli`, `subtotal`) VALUES
...
INSERT INTO `detail_penjualan` (`id_detailpenjualan`, `no_penjualan`, `kd_obat`, `hrg_jual`, `jml_jual`, `sat_jual`, `subtotal`) VALUES
...
('15330211', 'ALBOTHYL CONCENT 10ML', '2022-03-01', 'HV', 'CAIR', 'BOTOL', 46800, 39000, 209, 3),
...
('1811008', 'ACYCLOVIR 400 MG', '2023-01-01', 'PATEN', 'TABLET', 'TABLET', 1152, 960, 719, 15),
...
INSERT INTO `pembelian` (`id_pembelian`, `no_supplier`, `tgl_pembelian`, `cr_bayar`, `jth_tempo`, `total_pembelian`, `status_byr`, `tgl_lunas`, `id_peg`) VALUES
...
--
ALTER TABLE `detail_penjualan`
  MODIFY `id_detailpenjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=353;

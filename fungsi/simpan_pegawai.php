<?php 
	...
	$query_validasi = "SELECT id_peg FROM pegawai WHERE username = '$username'";
	...
	if($hasil_validasi) {
		...
		$query_id = "SELECT id_peg FROM pegawai WHERE pos_peg='$posisi' ORDER BY id_peg DESC";
		...
		$query = "INSERT INTO pegawai VALUES('$username', '$password', '$id', '$nama', '$alamat', '$no_hp', '$jk', '$tgl_lahir', '$tgl_masuk', '$posisi')";

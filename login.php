...
?>
  ...
  <head>
    ...
    <title>Login! PEREKAPAN DATA INSTANSI FARMASI "MESTI WARAS" </title>
    <link href="https://i.ibb.co/q01cCMv/logo.png" rel='icon'>

    <head>
      <style type="text/css">
        body {
          background-image: url('https://i.ibb.co/Ss8Gqdq/Untitled-2.jpg');
    ...
    <body>
      <div class="container">
        <div class="row">
          <div class="welcome col-lg-6 text-centered">
            SELAMAT DATANG DI SISTEM INFORMASI PEREKAPAN

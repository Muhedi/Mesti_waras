                ...
                <form method="post" id="form-pembelian" autocomplete="off">
                    <div class="row data-pembelian">
                        <div class="position-relative form-group col-md-4">
                            <label for="id_pembelian" class="">Nomor Faktur <small>(nomor pada kertas faktur)</small></label>
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control form-control-sm" id="id_pembelian" name="id_pembelian">
                        ...
                        <div class="position-relative form-group col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" class="form-control form-control-sm" id="id_supplier" name="id_supplier">
                                <div class="input-group-append">
                    ...
                    <div class="row tombol-kanan">
                        <div class="col-md-7 data-pembelian row">
                            ...
                            <div class="position-relative form-group col-md-4">
                                <label for="id_pembelian" class="">Cara Bayar</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="tabel_dataobat" class="table table-striped display">
            ...
            <tbody>
        <?php 
            $query_tampil = "SELECT * FROM obat ORDER BY nm_obat ASC";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="example" class="table table-striped display">
            ...
            <tbody>
        <?php 
            $query_tampil_supp = "SELECT * FROM supplier ORDER BY nama_supp ASC";
                ...
                <tr>
                    ...
                    <td class="td-opsi">
                        <button class="btn-transition btn btn-outline-dark btn-sm" title="pilih" id="tombol_pilihsupp" name="tombol_pilihsupp" data-dismiss="modal"
                            data-id_supplier="<?php echo $data_supp['id_supplier']; ?>"
...
$(document).ready(function() {
    ...
    $("#simpan_pembelian").click(function () {
        ...
        if(id_pembelian=="") {
            document.getElementById("id_pembelian").focus();
            Swal.fire(
              'Data Belum Lengkap',
            ...
            Swal.fire({
              ...
              if (simpan.value) {
                ...
                if(count_data > 0) {
                    ...
                    $.ajax({
                        url: "fungsi/simpan_pembelian.php",
                        method: "POST",
                        data: form_data,

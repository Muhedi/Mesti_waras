		...
		<div class="row" style="padding: 0 16px;">
			<div class="col-md-12 vertical-form">
                ...
                <?php 
                    ...
                    $carikode = mysqli_query($conn, "SELECT MAX(id_penjualan) FROM penjualan WHERE tgl_penjualan = '$tgl_penjualan'") or die (mysql_error());
                    $datakode = mysqli_fetch_array($carikode);
                    if($datakode) {
                        $nilaikode = substr($datakode[0], 13);
                        $kode = (int) $nilaikode;
                        $kode = $kode + 1;
                        $id_penjualan = "PJL/".$tgl."/".str_pad($kode, 2, "0", STR_PAD_LEFT);
                    } else {
                        $id_penjualan = "PJL/".$tgl."/01";
                    }
                 ?>

                <div style="text-align: right;">
                    No Penjualan : <b><?php echo $id_penjualan; ?></b> <br>
                ...
                <form method="post" id="form_penjualan" autocomplete="off">
                    <div class="position-relative row form-group">
                        ...
                        <div class="col-sm-4">
                        	<input name="id_penjualan" id="id_penjualan" placeholder="nomor penjualan" type="hidden" class="form-control form-control-sm" value="<?php echo $id_penjualan; ?>">
                        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="tabel_dataobat" class="table table-striped display">
            ...
            <tbody>
        <?php 
            $query_tampil = "SELECT * FROM obat INNER JOIN stok_obat ON obat.kd_obat = stok_obat.kd_obat WHERE stok_obat.tgl_exp > date_add(CURDATE(), INTERVAL 10 DAY) AND stok_obat.stok > 0 ORDER BY obat.nm_obat ASC";
            ...
            Swal.fire({
              ...
              if (simpan.value) {
                ...
                if(count_data > 0) {
                    ...
                    $.ajax({
                        url: "fungsi/simpan_penjualan.php",
                        method: "POST",
                        data: form_data,

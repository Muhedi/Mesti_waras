...
<div class="page-content">
	...
	<div class="table-container">
		...
		<?php 
			...
			$query_tampil = "SELECT * FROM supplier";
		 ...
		 ?>
		 		<tr>
		 			...
		 			<td class="td-opsi">
                        <button class="btn-transition btn btn-outline-primary btn-sm" title="edit" id="tombol_edit" name="tombol_edit" data-id="<?php echo $data['id_supplier']; ?>">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn-transition btn btn-outline-danger btn-sm" title="hapus" id="tombol_hapus" name="tombol_hapus" data-id="<?php echo $data['id_supplier']; ?>" data-nama="<?php echo $data['nama_supp']; ?>">
	...
	$("button[name='tombol_hapus']").click(function() {
		...
		Swal.fire({
          ...
          if (hapus.value) {
            $.ajax({
              type: "POST",
              url: "fungsi/hapus.php?page=supplier",
              data: "id="+id,

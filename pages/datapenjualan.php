...
<div class="page-content">
	...
	<div class="table-container">
		<table id="penjualan" class="table table-striped display tabel-data">
			<thead>
		        <tr>
		            <th>No</th>
		            <th>No Penjualan</th>
		    ...
		    <tbody>
		    	<?php 
		    		...
		    		$query_tampil = "SELECT * FROM penjualan INNER JOIN pegawai ON penjualan.id_peg = pegawai.id_peg ORDER BY penjualan.tgl_penjualan DESC, penjualan.id_penjualan DESC ";
		    	 ...
		    	 ?>
		    	 	<tr>
		    	 		...
		    	 		<td><?php echo $data_pjl['id_penjualan']; ?></td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        	<table class="tabel-profil">
        		...
        		<tr>
        			<th>Pegawai</th>
        			<td id="nama_pegdetail">Muhammad Edi ilfa</td>
        		</tr>
        	</table>
...
<script>
	$("button[name='tombol_detail']").click(function() {
		...
		$.ajax({
			type: "GET",
			url: "fungsi/detail.php?page=penjualan",
			data: "no_pjl="+no_pjl,
	...
	$("button[name='tombol_hapus']").click(function() {
		...
		Swal.fire({
          ...
          if (hapus.value) {
            $.ajax({
              type: "POST",
              url: "fungsi/hapus.php?page=datapenjualan",
              data: "id="+no_pjl,
